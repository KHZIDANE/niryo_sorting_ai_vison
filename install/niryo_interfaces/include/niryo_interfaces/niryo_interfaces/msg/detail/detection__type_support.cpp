...
{
  new (message_memory) niryo_interfaces::msg::Detection(_init);
}

void Detection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<niryo_interfaces::msg::Detection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection_message_member_array[6] = {
  {
    ...
    offsetof(niryo_interfaces::msg::Detection, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_interfaces::msg::Detection, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_interfaces::msg::Detection, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_interfaces::msg::Detection, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_interfaces::msg::Detection, label),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_interfaces::msg::Detection, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection_message_members = {
  "niryo_interfaces::msg",  // message namespace
  "Detection",  // message name
  6,  // number of fields
  sizeof(niryo_interfaces::msg::Detection),
...
get_message_type_support_handle<niryo_interfaces::msg::Detection>()
{
  return &::niryo_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_interfaces, msg, Detection)() {
  return &::niryo_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
