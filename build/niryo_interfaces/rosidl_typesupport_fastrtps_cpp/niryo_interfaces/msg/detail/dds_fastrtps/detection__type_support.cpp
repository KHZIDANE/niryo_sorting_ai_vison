...
#include "niryo_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_niryo_interfaces
cdr_serialize(
  const niryo_interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  niryo_interfaces::msg::Detection & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = niryo_interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const niryo_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<niryo_interfaces::msg::Detection *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_niryo_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<niryo_interfaces::msg::Detection>()
{
  return &niryo_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_interfaces, msg, Detection)() {
  return &niryo_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
