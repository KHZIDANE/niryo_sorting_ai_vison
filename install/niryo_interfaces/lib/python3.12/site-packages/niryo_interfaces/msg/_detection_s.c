...
bool niryo_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("niryo_interfaces.msg._detection.Detection", full_classname_dest, 41) == 0);
  }
  niryo_interfaces__msg__Detection * ros_message = _ros_message;
  {  // x
...
PyObject * niryo_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("niryo_interfaces.msg._detection");
